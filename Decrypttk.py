...
def decrypt(PassPhrase,message):
    ...
    #message = "df64c3c148794094b9cf0d765b8bb22c8725aec4a3120eebead5db354ca5d165"
    #input()
    ...
    for y in range(1, loopmsg): # loop to encrypt all segments of the message
        ...
        #print(asciioutput)
        displayLabel.insert(END, asciioutput )

# junk = "nasir"
# sth = "df64c3c148794094b9cf0d765b8bb22c8725aec4a3120eebead5db354ca5d165"
# decrypt(junk,sth)
...
label = Label(root, text="AES DECRYPTION" , font="20")
...
inputText1 = Label(root, text= "Enter CipherText Message: ") # input plaintext message
...
displayLabel = Text(root, fg="blue",height=10, width= 60)
displayLabel.grid(row=7,column=1)

# displayLabel2 = Label(root, fg="blue")
# displayLabel2.grid(row=7,column=1)
resultText1 = Label(root, text= "Your PlainText Message:")
